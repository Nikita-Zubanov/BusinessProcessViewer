Vue.component("start-signal-event-element", {
    props: {
        uId: String,
        name: String,
        x: Number,
    ...
    template: `
        <div class="start-signal-event-element">
            ...
            <details-element
                ...
                <start-signal-details
                    ...
                    :signal="details.event.signal"
                    :entitySchema="details.entitySchema"></start-signal-details>
